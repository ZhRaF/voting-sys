...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='demandcandidature',
            constraint=models.UniqueConstraint(fields=('user', 'election'), name='unique_demand_per_election'),
        ),
        migrations.AddConstraint(
            model_name='vote',
            constraint=models.UniqueConstraint(fields=('user', 'election'), name='unique_vote_per_election'),
        ),
    ]
